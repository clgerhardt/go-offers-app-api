...
import (
	...
	"github.com/clgerhardt/offersapp/models"
	"github.com/clgerhardt/offersapp/routes"
...
func connectDB() (c *pgx.Conn, err error) {
	conn, err := pgx.Connect(context.Background(), "postgresql://postgres:Cooper4fox!@localhost:5432/offersapp2")
	if err != nil {
